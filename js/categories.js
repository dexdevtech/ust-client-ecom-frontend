...
const men__hover = document.querySelector('.men__hover__');
const men__pop__up = document.querySelector('.pop__up__men__');
const women__hover = document.querySelector('.women__hover__');
const women__pop__up = document.querySelector('.pop__up__women__');
const kids__hover = document.querySelector('.kids__hover__');
const kids__pop__up = document.querySelector('.pop__up__kids__');
